...
class EmployeeController extends Controller
{
    ...
    {
        $data['title'] = "Employee Manage";
        $data['employees'] = Employee::with('region')->get();
        $data['regions'] = Region::get();
        return view('admin.pages.employee.index')->with($data);
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            Alert::success('Success', 'New employee is added!');
