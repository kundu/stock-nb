...
<link rel="icon" href="{{ asset('/images/fav.png') }}" type="image/png">
        ...
        <title>Stock Admin || Permission</title>
  ...
  <div class="br-mainpanel">
    <div class="br-pagetitle">
      <div>
        <h4>Permission</h4>
        <p class="mg-b-0">All permissions</p>
    ...
    <div class="br-pagebody">
        <div class="row">
          <div class="col-12">
            <button class="btn btn-secondary btn-xs pull-right" type="button" data-toggle="modal" data-target=".bs-example-modal-lg">Add New Permission</button>
          </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="x_content">
                        <br />
                        <form class="" action="{{ url::to('/admin/user-role/permission/create') }}" method="post">
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">

                            <div class="form-group row">
                                <div class="col-12">
                                    <label class="col-12">Permission Name<span class="required">*</span></label>
                                    <div class="col-12">
                                        <input class="form-control" placeholder="Permission Name" name="name" required="required" />
                                    </div>
                                </div>
                            </div>
